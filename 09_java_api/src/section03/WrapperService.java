...
public class WrapperService {
	...
	public void printValue(Object obj) {
		System.out.println("값 출력 : " + obj);		// .toString)
	...
	public void test3() {
		...
		System.out.println("int는 몇비 트? " + Integer.SIZE);
		...
		System.out.println("double는 몇비 트? " + Double.SIZE);
...
//		String s1 = num1;	// 오류(왜? 자료형 불일치)
		...
		// 방법 2) Wrapper Class의 valueOf() / toString()
		// -> int 값이 필드에 세팅된 integer 객체를 반환
		int num2 = 700;
