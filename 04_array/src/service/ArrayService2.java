...
public class ArrayService2 {
	...
	public void method1() {
		...
		// 해시코드(쭈소 비슷)가 다름을 확인 -> 서로 다른 배열 참조
		...
		// 깊은 복사 진행
		System.arraycopy(copyArr2, 0, copyArr3, 0, arr2.length);
	...
	public void method2() {
		...
		// 확인
		// arr[0] : [I@1da51a35 <- [ : 배열    I : Int   @1da51a35 : 16진수 참조 주소
