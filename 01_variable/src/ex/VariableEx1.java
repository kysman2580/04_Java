...
public class VariableEx1 {
	...
	public static void main(String[] args) {
		 ...
		 * long	 (8byte)
		 * -> 숫자 뒤에 L 또는 l을 붙임(L,l의 long 리터럴)
		 * 
		 * - 실수형
		 * float (4btyte)
		 * 
		...
		System.out.println("ㅡㅡㅡㅡㅡㅡㅡ논리형ㅡㅡㅡㅡㅡㅡㅡ");
		...
		System.out.println("ㅡㅡㅡㅡㅡㅡㅡ정수형ㅡㅡㅡㅡㅡㅡㅡ");
		
		int intNum1 = 217483647;	// int 최대 값
		// -> int 범위 초과한 값을 개입 불가!!
		// --> 정수형 중에서 범위가 더 lont 사고
...
//		int intNum2 = 2147483648;
		...
		// [실수형]
		System.out.println("ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ");
		System.out.println("ㅡㅡㅡㅡㅡㅡㅡ실수형ㅡㅡㅡㅡㅡㅡㅡ");
		...
		System.out.println("ㅡㅡㅡㅡㅡㅡ[문자형]ㅡㅡㅡㅡㅡㅡ");
