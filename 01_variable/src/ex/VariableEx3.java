...
public class VariableEx3 {
	...
	public static void main(String[] args) {
		...
		System.out.println("result : " + result1); // 34
		...
		System.out.println("(double)a3 / (double)b3 : " + (double)a3 / (double)b3);
		
		System.out.println("(double)a3 / b3 : " + (double)a3 / b3);
		
		System.out.println("a3 / (double)b3 : " + a3 / (double)b3);
		...
		System.out.println("A의 뒤에 10번째 문자 : " + ('A' + 10)); // 
		System.out.println("A의 뒤에 10번째 문자 : " + (char)('A' + 10)); // K
