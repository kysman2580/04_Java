...
public class ConsumerTest {
	public static void main(String[] args) {
		...
		/**
		 * Consumer 계열 - 매개 변수를 받아서 소비하는 함수형 인터페이스 - 반환 값 없음(매개 변수가 소비됨)
		 */
//		 Consumer<T> : "매개 변수 T를 전달 받아 소비"
		Consumer<String> printString = (message) -> {
...
//		ObjLongConsumer<T> : T와 Long을 전달 받아 소비
		 ...
		 * 
		 * LocalDate.plusDays(long l) : 저장된 시간에서 l 일 후 날짜 반환
		 */
	}
