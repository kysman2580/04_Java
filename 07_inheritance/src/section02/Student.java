...
public class Student extends Person {
	 ...
	 * - super() 생성자는 반드시 자식 생성자의 첫 번째 줄에 작성 되어야 한다! (미작성 시 컴파일러 자동 추가)
	 */
	...
	/*
	 * super 참조 변수(부모 참조 변수) - 자식 내 부모 객체를 참조하는 변수 - 부모의 필드/메서드에 접근하기 위해 사용
	 *  
	 */
...
//				getName(), getAge(), schoolName);
	...
	/*
	 * Person.introduce()메서드 오버라이딩 (째정의 )
	 * 
	 * 오버라이딩 성립 조건 [변경 불가] - 반환형 - 메서드명 - 매개변수(개수, 순서, 타입)
	 * 
	 * [변경 가능] - 접근 제어자(기존 -> 넓은 범위- 예외 처리 (기존 -> 좁은 범위)
	 * 
	 * 
...
//				"[Student가 재정의] 내 이름은 %s, %s 이죠!", super.getName(), alias);
