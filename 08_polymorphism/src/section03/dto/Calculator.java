...
/**
 * Calculator 인터페이스 -> 객체 생성 용도 X, 클래스/객체 간의 접점 용도 O
 */
public interface Calculator {
	...
	/*
	 * 기본적으로 추상 메서드만 작성 가능! -> 추상 메서드는 상속 받은 자식 클래스에서 오버라이딩이 강제됨
	 */

	/**
	 * 두 수의 합을 반환 단, 결과는 최대, 최소 값을 넘을 수 없음
	 * 
	 * @param a
	 * @param b
	 * @return 결과
	...
	/**
	 * 두 수의 차를 반환 단, 결과는 최대, 최소 값을 넘을 수 없음
	 * 
	 * @param a
	 * @param b
	 * @return 결과
	...
	/**
	 * 두 수의 곱을 반환 단, 결과는 최대, 최소 값을 넘을 수 없음
	 * 
	 * @param a
	 * @param b
	 * @return 결과
	...
	/**
	 * 두 수를 나눈 몫을 반환 단, 결과는 최대, 최소 값을 넘을 수 없음
	 * 
	 * @param a
	 * @param b
	 * @return 결과
	...
	/**
	 * 두 수를 나눈 나머지를 반환 단, 결과는 최대, 최소 값을 넘을 수 없음
	 * 
	 * @param a
	 * @param b
	 * @return 결과
	...
	/**
	 * a를 x만큼 거듭 제곱한 결과를 반환 단, 결과는 최대/최소 값을 넘을 수 없음
	 * 
	 * @param a
	 * @param x
	 * @return 결과
	...
	/**
	 * 원의 넓이를 반환 단, 결과는 최대/최소 값을 넘을 수 없음
	 * 
	 * @param r
	 * @return 결과
	 */
	...
	/**
	 * 전달 받은 num이 최대/최소를 초과하는지 확인 - 최대값 초과 시 MAX_NUM 반환 - 최소값 미만 시 MIN_NUM 반환 - 범위 내
	 * 숫자는 그냥 반환
	 * 
	 * @param num
	 * @return 결과
