...
import section03.dto.KYSCalculator;
import section03.dto.KYSCalculator2;
...
//		Calculator calc = new KYSCalculator();	
		...
		Calculator calc = new KYSCalculator2();
//		Calculator calc = new BDHCalculator();

		System.out.println(calc.plus(1234 , 5678));
		System.out.println(calc.minus(10000000 , 9999999));
		System.out.println(calc.multi(1560 , 2000));
