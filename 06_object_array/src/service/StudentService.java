...
public class StudentService {
	...
	/** targetName과 이름이 일치하는 학생 객체 반환하는 service 메서드
	 * @param targetName
	...
	public String selectMaxMin() {
		...
		for(StudentDTO std : students) { // StudentDTO의 객체 배열 students 를 std라고 부르겠다
